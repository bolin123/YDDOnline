...
#define WIRED_PROTO_RECV_MODE() HalGPIOSetLevel(HAL_WIRED_PROTO_485DE_PIN, 0)
#define WIRED_PROTO_SEND_MODE() HalGPIOSetLevel(HAL_WIRED_PROTO_485DE_PIN, 1)
...
void WiredProtoInit(WiredProtoQuery_cb queryCallback)
{
    ...
    HalGPIOConfig(HAL_WIRED_PROTO_485DE_PIN, HAL_IO_OUTPUT);//pa11
    WIRED_PROTO_RECV_MODE();
}
